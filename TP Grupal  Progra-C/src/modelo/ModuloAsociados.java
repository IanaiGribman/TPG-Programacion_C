...
public class ModuloAsociados extends ObservableAbstracto {
	...
	/**
	 * Devuelve un dto de asociado registrado en newValue o transmite el mensaje de error en caso de fallar
	...
	/**
	 * Devuelve el dni del eliminado en newValue o transmite el mensaje de error en caso de fallar
	 * @param dniAEliminar
	 */
