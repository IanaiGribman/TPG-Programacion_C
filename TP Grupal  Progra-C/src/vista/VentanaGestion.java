...
<<<<<<< HEAD
	private static final String toolTipSimulacionVacia = "<html> <b> <font color='red'>" +
															 "Error: " +
														  "</font> </b> <b> <font color='black'> " +
															 "Debe a�adir asociados a la ventana de simulacion para empezar la simulacion" +
=======
	private static final String toolTipSimulacionVacia = "<html> <b> <font color='black'> " +
															 "A�ada asociados a la ventana de simulacion para empezar la simulacion." +
...
>>>>>>> branch 'main' of https://github.com/IanaiGribman/TPG-Programacion_C.git
	...
	public void valueChanged(ListSelectionEvent e) {
		...
		if (e.getSource().equals(this.asociadosPersistenciaJList)) {
			...
			if (asoc != null) {
				if (this.asociadosSimulacionDLM.isEmpty())
					this.textFieldDniEliminacion.setText(asoc.getDni()); //si no esta vacia no tiene sentido a�adir el dni
				this.revalidadBotonEliminar();
				this.revalidarBotonAgregarSimulacion();
			}
		}
